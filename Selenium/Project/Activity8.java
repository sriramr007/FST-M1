...
public class Activity8 {
	...
	public void activity8(String username, String password) throws InterruptedException {
		...
		WebElement accountsSubmenu = driver.findElement(By.xpath("//a[starts-with(@id, 'moduleTab') and contains(text(), 'Accounts')]"));
		...
		for (int row=1; row<10; row+=2) {
			...
			System.out.println("Account"+row+" Name : " + nameText);
			Reporter.log("Account"+row+" Name : " + nameText);
			Reporter.log("<br>");
